                ...
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading">
                            详情  &nbsp&nbsp
                            <button style="margin-left: 30px" class="btn btn-default"><a href="<?php echo U('Income/pact_man_add');?>?id=<?php echo ($data['id']); ?>">合同录入</a></button>
                            ...
                            <div class="adv-table">
                                <table class="display table table-bordered" id="hidden-table-info">
                                    ...
                                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr class="gradeX">
                                            ...
                                            <td class="hidden-phone"><?php echo ($v["department_name"]); ?></td>
                                            <td class="center hidden-phone"><?php echo ($v["contract_date"]); ?></td>
                                            <td class="center">
                                                <?php echo ($v["contract_name"]); ?>
                                            </td>
                                            <td class="center hidden-phone"><a style="cursor:pointer" href="<?php echo U('Income/pact_post_show');?>?id=<?php echo ($v["id"]); ?>">详情</a></td>
                                            <td class="center"> <a style="cursor:pointer"  onclick='del_com("<?php echo ($v["id"]); ?>")'>删除</a></td>
