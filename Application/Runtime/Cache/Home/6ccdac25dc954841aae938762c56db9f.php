...
<section>
    ...
    <div class="left-side-inner">
        ...
        <div class="page-heading">
            ...
            <!--<a href="javascript:history.back(-1)"><img width="40" height="50" src="/badcat/Public//images/back.png"/></a>-->
        </div>
        <!-- page heading end-->
                ...
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <button style="margin-left: 30px" class="btn btn-default"><a href="<?php echo U('Income/apply_man_add');?>?id=<?php echo ($data['id']); ?>">添加</a></button>
                            ...
                            <div class="adv-table">
                                <table class="display table table-bordered" id="hidden-table-info">
                                    ...
                                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr class="gradeX">
                                            <td><?php echo ($k); ?></td>
                                            <td><?php echo ($v["expenses_no"]); ?></td>
                                            <td class="hidden-phone"><?php echo ($v["income_amt"]); ?></td>
                                            <td class="hidden-phone"><?php echo ($v["expenses_man_name"]); ?></td>
                                            <td class="center hidden-phone"><?php echo ($v["expenses_date"]); ?></td>
                                            <td class="center">
                                                <?php if($v["expenses_flag"] == 0): ?>等待提交<?php endif; ?>
                                                <?php if($v["expenses_flag"] == 1): ?>已提交待审核<?php endif; ?>
                                                <?php if($v["expenses_flag"] == 2): ?>部门领导审核退回<?php endif; ?>
                                                <?php if($v["expenses_flag"] == 3): ?>待财务审核<?php endif; ?>
                                                <?php if($v["expenses_flag"] == 4): ?>财务审核退回<?php endif; ?>
                                                <?php if($v["expenses_flag"] == 5): ?>财务审核通过<?php endif; ?>
                                            </td>
                                            <td class="center hidden-phone"><a style="cursor:pointer" onclick='del_com("<?php echo ($v["id"]); ?>")'>提交</a></td>
                                            <td class="center"> <a style="cursor:pointer" href="<?php echo U('Income/apply_man_del');?>?id=<?php echo ($v["id"]); ?>">删除</a></td>
