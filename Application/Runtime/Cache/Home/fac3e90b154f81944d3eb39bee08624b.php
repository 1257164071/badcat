                ...
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <button style="margin-left: 30px" class="btn btn-default"><a href="<?php echo U('Depart/add_mingxi');?>?id=<?php echo ($data['id']); ?>">添加</a></button>
                            ...
                            <div class="adv-table">
                                <table class="display table table-bordered" id="hidden-table-info">
                                    ...
                                    <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr class="gradeX">
                                        ...
                                        <td class="center"> <a style="cursor:pointer" href="<?php echo U('Depart/depart_mingxi_del');?>?id=<?php echo ($v["id"]); ?>">删除</a></td>
