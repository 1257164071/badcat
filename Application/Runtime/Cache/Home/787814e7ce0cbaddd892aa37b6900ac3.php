                        ...
                        <div class="panel-body">
                            <div class="adv-table editable-table ">
                                <div class="clearfix">
                                    ...
                                    <span style="margin-left: 30px">添加新部门</span>
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="">
                                            ...
                                            <td><?php echo ($vo["depart_code"]); ?></td>
                                            <td class="center"><?php echo ($vo["depart_name"]); ?></td>
...
<script src="/badcat/Public/js/editable-table2.js"></script>
