                            ...
                            <div class="adv-table editable-table ">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="">
                                            ...
                                            <td><?php echo ($v["budget_amt"]); ?></td>
                                            <td><?php echo ($v["budget_man_name"]); ?></td>
                                            <td><?php echo ($v["budget_date"]); ?></td>

                                            <td class="center">
                                                <?php if($v["budget_flag"] == 0): ?>等待上报<?php endif; ?>
                                                <?php if($v["budget_flag"] == 1): ?>等待领导审批<?php endif; ?>
                                                <?php if($v["budget_flag"] == 2): ?>领导审批完成<?php endif; ?>
                                                <?php if($v["budget_flag"] == 3): ?>领导审批返回<?php endif; ?>
                                            </td>
