                            ...
                            <div class="adv-table editable-table ">
                                <div class="clearfix">
                                    <div class="btn-group">
                                        <button class="btn btn-primary">
                                            <a href="<?php echo U('Income/execute_send');?>">新建计划表</a> <i class="fa fa-plus"></i>
                                        </button>
                                    </div><br>
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="">
                                            ...
                                            <td><a class="edit" target="" href="<?php echo U('Income/execute_detail');?>?id=<?php echo ($v['id']); ?>">查看明细</a></td>
                                            <!--<td><a class="edit" href="#" onclick="openwin(<?php echo ($v['id']); ?>)">查看明细</a></td>-->
                                            <td> <a style="cursor:pointer" href="<?php echo U('Income/execute_send_shenhe');?>?id=<?php echo ($v["id"]); ?>">提交审核</a> </td>
...
<script>
    ...
    function del_com(data){
        var r = confirm("确定删除吗？");
        if(r == true){
            window.location.href="execute_del"+'?id='+data;
            return true;
        }else{
            return false;
        }
