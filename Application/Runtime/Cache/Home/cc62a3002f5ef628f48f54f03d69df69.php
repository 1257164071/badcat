                                ...
                                <div class="clearfix">
                                    <div class="btn-group">
                                        <button class="btn btn-primary">
                                            <a href="<?php echo U('Depart/depart_send');?>">新建预算表</a> <i class="fa fa-plus"></i>
                                        </button>
                                    </div><br>
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="">
                                            ...
                                            <td class="center">
                                                ...
                                                <?php if($v["budget_flag"] == 1): ?>已提交待审核<?php endif; ?>
                                                <?php if($v["budget_flag"] == 2): ?>部门领导审核退回<?php endif; ?>
                                                <?php if($v["budget_flag"] == 3): ?>待财务审核<?php endif; ?>
                                                <?php if($v["budget_flag"] == 4): ?>财务审核退回<?php endif; ?>
                                                <?php if($v["budget_flag"] == 5): ?>财务审核通过<?php endif; ?>
                                            </td>


                                            <td><a class="edit" target="" href="<?php echo U('Depart/yusuan_list');?>?id=<?php echo ($v['id']); ?>">查看明细</a></td>
                                            <!--<td><a class="edit" href="#" onclick="openwin(<?php echo ($v['id']); ?>)">查看明细</a></td>-->
                                            <td> <a style="cursor:pointer" href="<?php echo U('Depart/submit_yusuan');?>?id=<?php echo ($v["id"]); ?>">提交审核</a> </td>
...
<script>
    ...
    function del_com(data){
        var r = confirm("确定删除吗？");
        if(r == true){
            window.location.href="depart_send_del"+'?id='+data;
            return true;
        }else{
            return false;
        }
