                            ...
                            <div class="adv-table editable-table ">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="">
                                            ...
                                            <td><a onclick="get_quanxian('<?php echo ($v["id"]); ?>')" style="cursor:pointer;"  data-toggle="modal" data-target="#myModal">更改权限</a></td>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo U('index/quanxian_add');?>" method="post">
...
<script src="/badcat/Public/js/editable-table6.js"></script>
...
<script>
    ...
    function get_quanxian(data) {
        $.ajax({
            url: "<?php echo U('index/ajaxadd_quanxian');?>",
            type: 'POST',
            data:{data: data},
