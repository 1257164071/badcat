                        ...
                        <div class="panel-body">
                            <div class="adv-table editable-table ">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                    <?php if(is_array($user_list)): $i = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="">
                                            <td><?php echo ($v["user_code"]); ?></td>
                                            ...
                                            <td><a class="delete" href="javascript:;">删除</a><button class="btn btn-default" onclick='get_quanxian("<?php echo ($v["id"]); ?>")' style="margin-left: 30px" data-toggle="modal" data-target="#myModal">分配组</button></td>
...
<script src="/badcat/Public/js/editable-table.js"></script>
