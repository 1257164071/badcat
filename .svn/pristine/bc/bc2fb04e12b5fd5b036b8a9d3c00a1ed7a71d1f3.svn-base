...
class IndexController extends Controller {
    public function index(){
        ...
        $jihua_num = M('depart_income_plan')->where(['department_id'=>$session['department_id']])->count();
        $yusuan_num = M('depart_budget')->where(['department_id'=>$session['department_id']])->count();
        $hetong_num = M('contract')->where(['department_id'=>$session['department_id']])->count();
