...
<div class="container">
    ...
    <form class="form-signin" action="<?php echo U('Login/checkLogin');?>" method="post">
        <div class="form-signin-heading text-center">
            <h1 class="sign-title">登录</h1>
            <img src="/badcat/Public/images/login-logo.png" alt=""/>
        </div>
        <div class="login-wrap">
            <input type="text" name="user_code" class="form-control" placeholder="请输入用户编码" autofocus>
            ...
            <div class="registration">
                新用户
                <a class="" href="<?php echo U('Login/Register');?>">
                    注册
                </a>
            </div>
            <label class="checkbox">
                ...
                <span class="pull-right">
                    <a data-toggle="modal" href="#myModal"> 密码找回</a>
